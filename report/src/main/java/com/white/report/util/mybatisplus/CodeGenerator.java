package com.white.report.util.mybatisplus;
...
public class CodeGenerator {
    ...
    private static String packageName="report";    //文件路径
    ...
    private static String path = file.getAbsolutePath()+"/report";
...
//        };
        ...
        FileOutConfig fileOutConfig111 = new FileOutConfig("/templates/controller.java.ftl") {
            ...
            @Override
            public String outputFile(TableInfo tableInfo) {
                return path+"/src/main/java/com/niushibang/report/controller/core/" + tableInfo.getEntityName() + "Controller.java";
            }
        };
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                return path+"/src/main/java/com/niushibang/report/pojo/dto/" + tableInfo.getEntityName() + "DTO.java";
//            }
//        };
        ...
        FileOutConfig fileOutConfig333 = new FileOutConfig("/templates/entity.java.ftl") {
            ...
            @Override
            public String outputFile(TableInfo tableInfo) {
                return path+"/src/main/java/com/niushibang/report/pojo/entity/" + tableInfo.getEntityName() + ".java";
            }
        };
...
//                        .setModuleName(scanner("模块名"))
                        .setParent("com.niushibang."+packageName)// 自定义包路径
...
//                        map.put("table",this.getConfig().getTableInfoList().get(0));
                        ...
                        //pathUrl
                        String pathUrl = "com.niushibang."+packageName;
        ...
        System.out.println(mpg.getCfg().getMap().get("packageInfo"));
        System.out.println(mpg.getCfg().getMap().get("pathInfo"));
        System.out.println(mpg.getCfg().getMap().get("table"));
        System.out.println(mpg.getCfg().getMap().get("nameLowwerCaseCamel"));

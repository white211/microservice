...
public class CodeGeneratorAllFile {
    ...
    private static String path = file.getAbsolutePath()+"/user";
    ...
    public static void main(String[] args) {
        ...
        FileOutConfig fileOutConfig111 = new FileOutConfig("/templates/controller.java.ftl") {
            ...
            @Override
            public String outputFile(TableInfo tableInfo) {
                return path+"/src/main/java/com/white/user/controller/core/" + tableInfo.getEntityName() + "Controller.java";
            }
        };
        ...
        FileOutConfig fileOutConfig222 = new FileOutConfig("/templates/dto.java.ftl") {
            ...
            @Override
            public String outputFile(TableInfo tableInfo) {
                return path+"/src/main/java/com/white/user/pojo/dto/" + tableInfo.getEntityName() + "DTO.java";
            }
        };
        ...
        FileOutConfig fileOutConfig333 = new FileOutConfig("/templates/entity.java.ftl") {
            ...
            @Override
            public String outputFile(TableInfo tableInfo) {
                return path+"/src/main/java/com/white/user/pojo/entity/" + tableInfo.getEntityName() + ".java";
            }
        };

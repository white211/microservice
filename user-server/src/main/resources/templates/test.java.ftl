...
public class ${table.controllerName} {
    ...
    <#list table.fields as TableField>
         ...
         * @apiParam {${TableField.columnType}} [${TableField.name}] <code>body</code>${TableField.comment}
        </#if>
    </#list>
     *
     ...
     *
     */
    @PostMapping("${cfg.controllerPath}/new")
    ...
    @PostMapping("${cfg.controllerPath}/remove")
    @Transactional(rollbackFor = Exception.class)
    ...
    @PostMapping("${cfg.controllerPath}/update")
    @Transactional(rollbackFor = Exception.class)
    ...
    @GetMapping("${cfg.controllerPath}/page")
    ...
    @GetMapping("${cfg.controllerPath}/list")

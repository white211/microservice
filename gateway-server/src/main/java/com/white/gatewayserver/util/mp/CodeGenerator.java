package com.white.gatewayserver.util.mp;
...
public class CodeGenerator {
    ...
    private static String packageName="gatewayserver";    //文件路径
    private static String authorName="White";     //作者
    private static String table="tb_resource";                  //table名字
    //    private static String prefix="sc_";                     //table前缀
    private static File file = new File("");
    private static String path = file.getAbsolutePath()+"/gateway-server/";
